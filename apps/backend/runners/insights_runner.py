...
def build_system_prompt(project_dir: str, language: str = "en") -> str:
    ...
    if language and language != "en":
        ...
        language_instruction = f"\n\n**IMPORTANT LANGUAGE REQUIREMENT**: Respond in **{language_name}**. All explanations, suggestions, task titles, and descriptions must be in {language_name}.\n"

    return f"""You are an AI assistant helping developers understand and work with their codebase.{language_instruction}
...
async def run_with_sdk(
    ...
    system_prompt = build_system_prompt(project_dir, language)
...
def run_simple(project_dir: str, message: str, history: list, language: str = "en") -> None:
...
def main():
    ...
    parser.add_argument(
        ...
        default="en",
        choices=["en", "ko", "fr"],
        help="Language for AI-generated content (en=English, ko=Korean, fr=French)",
    )
    ...
    asyncio.run(run_with_sdk(project_dir, user_message, history, model, thinking_level, language))
