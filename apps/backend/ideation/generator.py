...
class IdeationGenerator:
    ...
    async def run_agent(
        ...
        if self.language and self.language != "en":
            ...
            prompt += f"\n\n**IMPORTANT LANGUAGE REQUIREMENT**: Generate ALL content (idea titles, descriptions, rationales, impact assessments, etc.) in **{language_name}**. The JSON keys and structure must remain in English, but all human-readable content values must be in {language_name}.\n"
