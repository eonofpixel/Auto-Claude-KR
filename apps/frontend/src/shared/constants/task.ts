...
// Execution phase label translation keys (use with t() from react-i18next)
export const EXECUTION_PHASE_LABEL_KEYS: Record<string, string> = {
  idle: 'execution.phases.idle',
  planning: 'execution.phases.planning',
  coding: 'execution.phases.coding',
  qa_review: 'labels.aiReview',
