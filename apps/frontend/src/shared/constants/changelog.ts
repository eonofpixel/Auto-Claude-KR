...
// Translation keys for source mode labels (use with t() from react-i18next)
export const CHANGELOG_SOURCE_MODE_LABEL_KEYS: Record<string, string> = {
  'tasks': 'common:changelog.sourceMode.labels.tasks',
  'git-history': 'common:changelog.sourceMode.labels.gitHistory',
  'branch-diff': 'common:changelog.sourceMode.labels.branchDiff'
};

// Translation keys for source mode descriptions (use with t() from react-i18next)
export const CHANGELOG_SOURCE_MODE_DESCRIPTION_KEYS: Record<string, string> = {
  'tasks': 'common:changelog.sourceMode.descriptions.tasks',
  'git-history': 'common:changelog.sourceMode.descriptions.gitHistory',
  'branch-diff': 'common:changelog.sourceMode.descriptions.branchDiff'
};
