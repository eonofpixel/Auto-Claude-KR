...
// Translation keys for ideation type labels (use with t() from react-i18next)
export const IDEATION_TYPE_LABEL_KEYS: Record<string, string> = {
  code_improvements: 'common:ideationType.labels.codeImprovements',
  ui_ux_improvements: 'common:ideationType.labels.uiUxImprovements',
  documentation_gaps: 'common:ideationType.labels.documentation',
  security_hardening: 'common:ideationType.labels.security',
  performance_optimizations: 'common:ideationType.labels.performance',
  code_quality: 'common:ideationType.labels.codeQuality'
};

// Translation keys for ideation type descriptions (use with t() from react-i18next)
export const IDEATION_TYPE_DESCRIPTION_KEYS: Record<string, string> = {
  code_improvements: 'common:ideationType.descriptions.codeImprovements',
  ui_ux_improvements: 'common:ideationType.descriptions.uiUxImprovements',
  documentation_gaps: 'common:ideationType.descriptions.documentation',
  security_hardening: 'common:ideationType.descriptions.security',
  performance_optimizations: 'common:ideationType.descriptions.performance',
  code_quality: 'common:ideationType.descriptions.codeQuality'
};
...
// Fallback descriptions for non-i18n contexts
