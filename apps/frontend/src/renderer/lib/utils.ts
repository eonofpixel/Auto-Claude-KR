 ...
 * @param t Optional translation function from react-i18next. If provided, uses common:time translations.
 * @returns Relative time string (e.g., "2 hours ago" or translated equivalent)
 */
export function formatRelativeTime(date: Date, t?: TranslationFunction): string {
  ...
  if (t) {
    // Use translations from common:time namespace
