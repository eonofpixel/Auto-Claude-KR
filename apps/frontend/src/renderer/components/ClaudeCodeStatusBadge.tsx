                  ...
                  <SelectValue
                    placeholder={
                      isLoadingVersions
                        ...
                        : versionsError
                          ? t("navigation:claudeCode.failedToLoadVersions", "t('navigation:claudeCode.failedToLoadVersions')")
                  ...
                  <SelectValue
                    placeholder={
                      isLoadingInstallations
                        ...
                        : installationsError
                          ? t("navigation:claudeCode.failedToLoadInstallations", "t('navigation:claudeCode.failedToLoadInstallations')")
