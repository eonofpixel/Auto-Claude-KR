        ...
        <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  <h3 className="text-lg font-medium text-foreground">
                    {t('settings:claudeOAuth.title')}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {t('settings:claudeOAuth.description')}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {t('settings:claudeOAuth.browserPrompt')}
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <div className="flex justify-center">
            <Button onClick={handleStartAuth} size="lg" className="gap-2">
              ...
              {t('settings:claudeOAuth.authenticateButton')}
            </Button>
          </div>
        </div>
      )}
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-medium text-foreground">
                    {t('settings:claudeOAuth.authenticating')}
                  </h3>
                  <p className="text-sm text-muted-foreground mt-1">
                    {t('settings:claudeOAuth.terminalOpened')}
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg bg-background/50 p-3 space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-muted-foreground space-y-1">
                    <p className="font-medium">{t('settings:claudeOAuth.whatsHappening')}</p>
                    <ol className="list-decimal list-inside space-y-1 ml-2">
                      <li>{t('settings:claudeOAuth.step1')}</li>
                      <li>{t('settings:claudeOAuth.step2')}</li>
                      <li>{t('settings:claudeOAuth.step3')}</li>
                      <li>{t('settings:claudeOAuth.step4')}</li>
                      <li>{t('settings:claudeOAuth.step5')}</li>
                    </ol>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-medium text-success">
                  {t('settings:claudeOAuth.successTitle')}
                </h3>
                <p className="text-sm text-success/80 mt-1">
                  {email ? t('settings:claudeOAuth.connectedAs', { email }) : t('settings:claudeOAuth.credentialsSaved')}
                </p>
                <div className="flex items-center gap-2 mt-3 text-xs text-success/70">
                  <Sparkles className="h-3 w-3" />
                  <span>{t('settings:claudeOAuth.featuresEnabled')}</span>
                </div>
              </div>
            </div>
          </CardContent>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-medium text-destructive">
                    {t('settings:claudeOAuth.errorTitle')}
                  </h3>
