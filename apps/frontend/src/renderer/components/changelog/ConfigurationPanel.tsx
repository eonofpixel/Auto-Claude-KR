        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-muted/50 p-3">
            <div className="flex items-center gap-2 text-sm font-medium">
              ...
              {t('common:changelog.including', { count: summaryInfo.count, label: summaryInfo.label })}
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={t('common:changelog.placeholders.version')}
              />
            </div>
            <div className="space-y-2">
            ...
            {(existingChangelog?.lastVersion || versionBumpDescription) && (
              <div className="text-xs text-muted-foreground space-y-1">
                {existingChangelog?.lastVersion && (
                  <p>{t('common:changelog.previous', { version: existingChangelog.lastVersion })}</p>
                )}
              ...
              <CardContent className="pt-4">
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder={t('common:changelog.placeholders.customInstructions')}
                    rows={3}
                  />
                  <p className="text-xs text-muted-foreground">
                    {t('common:changelog.customInstructionsDescription')}
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        >
          {isGenerating ? (
            ...
            <>
              ...
              {t('common:changelog.generateChangelog')}
            </>
          )}
        </Button>
