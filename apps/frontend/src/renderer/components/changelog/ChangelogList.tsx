          ...
          <div className="flex items-center justify-between border-b border-border px-6 py-3 bg-muted/30">
            <div className="flex items-center gap-4">
              <span className="text-sm font-medium">
                {t('common:changelog.tasksSelected', { selected: selectedTaskIds.length, total: doneTasks.length })}
              </span>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground max-w-md">
                    {sourceMode === 'git-history'
                      ? t('common:changelog.noCommitsDescription.gitHistory')
                      : t('common:changelog.noCommitsDescription.branchDiff')}
                  </p>
                </div>
              </div>
            ) : (
