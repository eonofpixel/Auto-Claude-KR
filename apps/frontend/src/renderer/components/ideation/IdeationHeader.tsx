      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="text-lg font-semibold">{t('ideationPage.title')}</h2>
            <Badge variant="outline">{t('ideationPage.ideasCount', { count: totalIdeas })}</Badge>
          </div>
          <p className="text-sm text-muted-foreground">
            {t('ideationPage.description')}
          </p>
        </div>
          ...
          {hasSelection ? (
            <>
              <Badge variant="secondary" className="mr-1">
                {t('ideationPage.selected', { count: selectedCount })}
              </Badge>
              <Button
                variant="outline"
                size="sm"
