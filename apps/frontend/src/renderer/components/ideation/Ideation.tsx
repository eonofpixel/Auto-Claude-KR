...
import { IDEATION_TYPE_DESCRIPTION_KEYS } from '../../../shared/constants';
    ...
    return (
      <>
        ...
        <EnvConfigModal
          ...
          title={t('ideationPage.authRequired')}
          description={t('ideationPage.authDescription')}
          projectId={projectId}
        />
      </>
    );
            ...
            <div className="grid gap-3">
              ...
              {activeIdeas.length === 0 && (
                <div className="text-center py-8 text-muted-foreground">
                  {t('ideationPage.noIdeasToDisplay')}
                </div>
              )}
            </div>
          </TabsContent>
