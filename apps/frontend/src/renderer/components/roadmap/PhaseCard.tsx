...
import { ROADMAP_PRIORITY_COLORS, ROADMAP_PRIORITY_LABEL_KEYS, ROADMAP_STATUS_LABEL_KEYS } from '../../../shared/constants';
    ...
    <Card className="p-4">
      <div className="flex items-start justify-between mb-3">
        ...
        <Badge variant={phase.status === 'completed' ? 'default' : 'outline'}>
          {t(ROADMAP_STATUS_LABEL_KEYS[phase.status] || `roadmapFeature.status.${phase.status}`)}
        </Badge>
      </div>
      ...
      {/* Features */}
      <div>
        <h4 className="text-sm font-medium mb-2">{t('roadmap.phaseCard.featuresTitle', { count: features.length })}</h4>
