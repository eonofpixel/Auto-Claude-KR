      ...
      <Card className="bg-muted/30 border-border/50">
        <CardContent className="pt-4">
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline">{t('context.prReview.fallbackTitle')}</Badge>
              ...
              <div className="flex items-center gap-2 mt-2 flex-wrap">
                ...
                {totalFindings > 0 && (
                  <span className="text-xs text-muted-foreground">
                    {t('context.prReview.findingsCount', { count: totalFindings })}
                  </span>
                )}
              </div>
            ...
            >
              {expanded ? (
                <>
                  ...
                  {t('context.prReview.collapse')}
                </>
              ) : (
                <>
                  <ChevronDown className="h-4 w-4" />
                  {t('context.prReview.details')}
                </>
              )}
            </Button>
          )}
            ...
            {hasFindings && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-foreground">{t('context.prReview.keyFindings')}</span>
                ...
                <div className="space-y-2 pl-6">
                  ...
                  {parsed.keyFindings.length > 5 && (
                    <p className="text-xs text-muted-foreground">
                      {t('context.prReview.moreFindings', { count: parsed.keyFindings.length - 5 })}
                    </p>
                  )}
                </div>
              </div>
            ...
            {hasGotchas && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-foreground">{t('context.prReview.gotchasDiscovered')}</span>
                  <Badge variant="secondary" className="text-xs px-1.5 py-0">
            ...
            {hasPatterns && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-foreground">{t('context.prReview.patternsIdentified')}</span>
                  <Badge variant="secondary" className="text-xs px-1.5 py-0">
            ...
            {parsed.repo && parsed.prNumber && (
              <div className="pt-2">
                ...
                >
                  ...
                  {t('context.prReview.viewOnGitHub')}
                </Button>
              </div>
            )}
          </div>
