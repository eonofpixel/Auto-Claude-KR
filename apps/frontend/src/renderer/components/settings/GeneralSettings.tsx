                  ...
                  <div key={feature} className="space-y-2">
                    <div className="flex items-center justify-between">
                      <Label className="text-sm font-medium text-foreground">
                        {t(`general.featureLabels.${feature}.label`, { defaultValue: FEATURE_LABELS[feature].label })}
                      </Label>
                      <span className="text-xs text-muted-foreground">
                        {t(`general.featureLabels.${feature}.description`, { defaultValue: FEATURE_LABELS[feature].description })}
                      </span>
                    </div>
