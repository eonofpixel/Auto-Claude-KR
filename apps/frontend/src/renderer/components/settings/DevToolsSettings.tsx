...
export function DevToolsSettings({ settings, onSettingsChange }: DevToolsSettingsProps) {
  ...
  ideOptions.push({ value: 'custom', label: t('devtools.ide.custom', 'Custom...'), detected: false });
  ...
  // Add custom option last
  terminalOptions.push({ value: 'custom', label: t('devtools.terminal.custom', 'Custom...'), detected: false });
