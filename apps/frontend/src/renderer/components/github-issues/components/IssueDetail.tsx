  ...
  return (
    <ScrollArea className="flex-1">
      <div className="p-4 space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
          ...
          {issue.commentsCount > 0 && (
            <div className="flex items-center gap-1">
              ...
              {issue.commentsCount} {t('github.issues.comments')}
            </div>
          )}
        </div>
                ...
                <>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">
                      {t('github.issues.taskId', { id: taskId })}
                    </span>
                  </div>
                </>
              ) : (
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm">{t('github.issues.description')}</CardTitle>
          </CardHeader>
          <CardContent>
            {issue.body ? (
        ...
        {issue.assignees.length > 0 && (
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm">{t('github.issues.assignees')}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex flex-wrap gap-2">
        ...
        {issue.milestone && (
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm">{t('github.issues.milestone')}</CardTitle>
            </CardHeader>
            <CardContent>
