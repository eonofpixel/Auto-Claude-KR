  ...
  useTranslation: () => ({
    t: (key: string) => {
      ...
      const translations: Record<string, string> = {
        ...
        'authChoice.oauthOption.title': 'Sign in with Anthropic',
        'authChoice.oauthOption.description': 'Use your Anthropic account to authenticate. Simple and secure OAuth flow.',
        'authChoice.apiKeyOption.title': 'Use Custom API Key',
        'authChoice.apiKeyOption.description': 'Bring your own API key from Anthropic or a compatible API provider.',
        'authChoice.bothOptionsInfo': 'Both options provide full access to Claude Code features.',
        'authChoice.skipForNow': 'Skip for now',
