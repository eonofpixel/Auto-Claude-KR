        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
            <AuthOptionCard
              ...
              title={t('authChoice.oauthOption.title')}
              description={t('authChoice.oauthOption.description')}
            ...
            <AuthOptionCard
              ...
              title={t('authChoice.apiKeyOption.title')}
              description={t('authChoice.apiKeyOption.description')}
