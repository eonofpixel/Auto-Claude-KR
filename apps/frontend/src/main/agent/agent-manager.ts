...
export class AgentManager extends EventEmitter {
  ...
  async startSpecCreation(
    ...
    // Pass language for AI-generated content
   ...
   */
  getRoadmapProgress(projectId: string): { phase: string; progress: number; message: string } | null {
    return this.queueManager.getRoadmapProgress(projectId);
  }
