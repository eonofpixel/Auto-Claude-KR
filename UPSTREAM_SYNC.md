...
### 2026-01-19 - 대규모 upstream 동기화
**버그 수정:**
- `f700b18d` cherry-pick: CodeQL 보안 수정

**터미널/백엔드:**
- `eb739afe` cherry-pick: 터미널 ESM/Sentry 호환성
- `b8655904` cherry-pick: planning→coding 재시도 로직
- `7cb9e0a3` cherry-pick: worktree 파일 누출 방지

**터미널 UI:**
- `75a3684c` cherry-pick: 터미널 렌더링/지속성/링크 수정 (i18n 유지하며 충돌 해결)
- `193d2ed9` cherry-pick: 프로젝트 전환 시 터미널 출력 멈춤 수정

**UI/UX:**
- `439ed86a` cherry-pick: 라이트 테마 prose-invert 수정

**새 기능:**
- `3606a632` cherry-pick: Kanban 드래그 앤 드롭 정렬 (+ 한국어 번역)
- `8833feb2` cherry-pick: Worktree 일괄 삭제 기능 (+ 한국어 번역)
- `87c84073` cherry-pick: PR 상세 뷰 브랜치 업데이트 버튼 (+ 한국어 번역)

**건너뜀:**
- `0b2cf9b0` (ESLint → Biome 마이그레이션) - 대규모 변경으로 나중에 검토
